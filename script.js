...
class Shell {
	...
	burst(x, y, createImage = true) {
		if(createImage) {
			console.log("TEST")
			showExplosionImage(x, y);
		}
...
const images = ["beauty0.png","beauty1.png", "beauty2.png", "beauty3.png", "beauty4.png", "beauty5.png", "beauty6.png", "beauty7.png", "beauty8.png"];
let counter = 0;
function showExplosionImage(x, y) {
  const img = document.createElement("img");
  img.src = `./img/${images[counter]}`; // <-- your image here
  img.className = "explosion-image";
